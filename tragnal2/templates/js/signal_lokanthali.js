...
// function for timer
    ...
    (function(){
        $.getJSON(
            $SCRIPT_ROOT+"/_imgLokanthali", // Your AJAX route here
            function(dota) {
                ...
                if(currentPhase ==1)
                {
                $('#jphase').attr('src',"{{ url_for('static', filename='images/junctions/Lokanthali/m1.png') }}");
                }
                else if(currentPhase==2)
                {
                $('#jphase').attr('src',"{{ url_for('static', filename='images/junctions/Lokanthali/m2.png') }}");
                }
                else
                {
                $('#jphase').attr('src',"{{ url_for('static', filename='images/junctions/Lokanthali/m3.png') }}");
                }
            });

...
traffic_phase_state_J = 1
isPhaseRessetted_J = None

phase = {}
phase_number = None
def jadibutiSeqGenerationFunction():
    global phase,phase_number, isPhaseRessetted_J, traffic_phase_state_J
    ...
    while True:
        ...
        if(isPhaseRessetted_J):
            tym = 0
            init_time = int(round(time.time()))

            if(traffic_phase_state_J==1):
                tym = phaseTime[0]

            if(traffic_phase_state_J == 2):
                tym = phaseTime[0] + phaseTime[1]

            if (traffic_phase_state_J == 3):
                tym = 0

            isPhaseRessetted_J = False
